        ...
        <ion-content>
            ...
            <div class="contractHtml">
                <div class="container d-flex flex-column justify-content-center mt-1" id="capture">
                    <div class=" container-fluid d-flex flex-column justify-content-center align-items-center"
                        ...
                        <p><b>CONTRATANTE:</b> <b> {{ client.name }} </b>, pessoa física
                            (<span v-if="client.type == 'PF'">X</span>) ou Jurídica (<span
                                v-if="client.type == 'PJ'">X</span>)
                            de direito privado, residente ou localizado
                            na <b> {{ client.houses[0].street }} </b> , Nº <b> {{ client.houses[0].number }} </b> ,
                            CEP <b> {{ client.houses[0].cep }} </b> Bairro <b> {{ client.houses[0].district }} </b> na
                            cidade de
                            Petrolina,
                            ...
                            CPF <b> <span v-if="client.type == 'PF'"> {{ client.cpf_cnpj }} </span> </b> telefone nº <b>
                                <span v-if="client.type == 'PF'"> {{ client.phone }} </span> </b>
                        ...
                        <p>O objetivo deste contrato é a prestação de serviços especializados de
                            ...
                            execução dos serviços, será estipulada pela Contratada
                        </p>
                        <p><b>Parágrafo primeiro:</b> - Os serviços serão executados exclusivamente na área interna
                            ...
                            Nº <b> {{ client.houses[0].number }} </b>, Bairro <b> {{ client.houses[0].district }} </b>, CEP
                            <b>
                                {{ client.houses[0].cep }} </b> Petrolina -
                        ...
                        <br>
                        <p>Pelos serviços contratados, o <b>Contratante (CLIENTE)</b> pagará ao <b>Contratado</b> (prestador
                            de
                            serviços)
                            a quantia mensal de <b>R$ {{ client.contracts[0].value }} </b>
                            (__________________________________)
                            até o
                            dia <b> {{ client.contracts[0].payday }} </b> do 1º mês <b>subsequente</b> ao vencido, através
                            de
                            faturamento e emissão de
                        ...
                        <br>
                        <p>O prazo deste contrato é por 12 meses, iniciando-se no dia <b> {{ dateDayOfContract }} </b> de
                            <b> {{
                                dateMonthOfContract }} </b> de
                            2023</p>
                        ...
                        <br>
                        <p>1) –(Opcional) Deixar à disposição da Contratada cópia das chaves de acesso interno do local
                            protegido para eventuais emergenciais sim ( ) ou não ( ).
                            <br><br>2) – Manter uma linha telefônica para comunicação direta necessária ao sistema de
                            monitoramento.
                            <br><br>3) - O acionamento do alarme é de responsabilidade da Contratante.
                            <br><br>4) – Informar à Contratada dos problemas de ordem técnica no sistema eletrônico
                            monitorado.
                        </p>
                        <br>
                    </div>
                ...
                <div class="container d-flex flex-column justify-content-center" id="capture-2">
                    ...
                    <br>
                    <p>
                        1) – Providenciar a manutenção do sistema eletrônico monitorado, dentro do prazo de 72 (setenta e
                        duas) horas úteis após a comunicação da Contratante.
                        <br><br>2) – Manter com exclusividade o vínculo empregatício de todo o pessoal designado para
                        atender o monitoramento, o qual será identificado com vestimenta uniformizada.
                        <br><br>3) – Efetuar o atendimento de emergência ao evento do disparo do sistema de <b>monitoramento
                            eletrônico</b>, dentro do prazo de 20 (vinte minutos) salvo motivo de força maior decorrente das
                        condições do trafego urbano.
                    ...
                    <br>
                    <br>
                    <p style="text-align: center;"> Petrolina, {{ dateDayOfContract }} de {{ dateMonthOfContract }} de 2023
                    </p>
                    <br>
                    <br>
    ...
    methods: {
        ...
        async generatePDF() {
            ...
            await html2canvas(html2, {
                ...
                doc.addImage(img, 'PNG', 7, 13, 195, 150);
